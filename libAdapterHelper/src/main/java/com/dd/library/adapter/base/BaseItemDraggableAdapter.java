...
import com.dd.library.adapter.base.callback.ItemDragAndSwipeCallback;
import com.dd.library.adapter.base.listener.OnItemDragListener;
import com.dd.library.adapter.base.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public void onBindViewHolder(K holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
                && viewType != EMPTY_VIEW && viewType != FOOTER_VIEW && viewType != REFRESH_VIEW) {
