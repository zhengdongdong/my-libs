...
public class LunarCalendarUtil {
     ...
     * @return
     */
    public static String getLunarDayString(int month, int day) {
     ...
     * 公历转农历
     */
    public static LunarCalendarModel solarToLunar(CalendarModel solar) {
        LunarCalendarModel lunar = new LunarCalendarModel();
